...
import 'package:coffee_shop/pages/detail_screen.dart';
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(coffee.type, style: TextStyle(color: secondaryColor)),
                    const Spacer(),
                    Row(
        ...
        itemBuilder: (context, index) {
          return GestureDetector(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: selectedIndex == index ? primaryColor : secondaryColor..withOpacity(0.1),
